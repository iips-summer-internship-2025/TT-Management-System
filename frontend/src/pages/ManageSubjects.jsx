...
const ManageSubjects = () => {
  ...
  const handleSaveNewSubject = async () => {
    ...
    try {
      ...
      alert(
        `Failed to ${newSubject.id ? "update" : "add"} subject: ${errorMessage}`
      );
    } finally {
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNewSubject((prev) => ({
                      ...
                      course_code:
                        courses.find((c) => c.ID == e.target.value)?.Code || "",
                    }))
                  }
              ...
              <div className="flex space-x-3 pt-4">
                ...
                >
                  {addingSubject ? (
                    ...
                    <span>
                      {newSubject.id ? "Update Subject" : "Add Subject"}
                    </span>
                  )}
                </button>
                <button
