...
const ManageCourses = () => {
        ...
        coursesData.map(async (course) => {
          try {
            ...
            const subjectsResponse = await fetch(
              `${API_BASE_URL}/course/${course.ID}/subjects`,
              {
                credentials: "include",
              }
            );
            ...
            const batchesResponse = await fetch(
              `${API_BASE_URL}/course/${course.ID}/batches`,
              {
                credentials: "include",
              }
            );
            const batches = batchesResponse.ok
  ...
  const handleSaveCourse = async () => {
    ...
    try {
      ...
      alert(
        `Failed to ${editingCourse ? "update" : "add"} course: ${err.message}`
      );
    } finally {
